...
-- description of figure 2. A ``social-technical  gap''  emerges when there is a  deficit  between  what  society  needs  and  what technology does \cite{Whitworth2014}. 

-- as mentioned earlier, socio-technical systems are systems of ``evolution'' rather than systems of ``revolution''. designers therefore also need to design and plan the change process \cite{Baxter2011}

-- many core difficulties stem from implementation of the design in the real world. that designers cannot stop at the design stage: they must play an active role in implementation, and develop solutions through small, incremental steps to reduce political, social, and cultural disruptions. \cite{Norman2015}


\runinhead{Design Process} The design process of socio-technical systems can be seen as a decision-making process where the problem owners, shareholders, users, and oteher stakeholders participate to represent their interests. Often, the design process is so complex that the process itself can be deemed as a socio-technical system \cite{Baxter2011}. 
...
\runinhead{Products or results of the design process} these not only consists of technological artifacts but also may include rules for behaviour, policies, etc. through which the designer wish to intervene in social-technical systems. what is it that we are designing? 
