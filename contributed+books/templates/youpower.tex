...
\subruninhead{Linking Energy Data to Energy Reduction Actions}

The design links energy data with energy reduction actions taken (Figure~\ref{fig:Figure201_Actions} a) at cooperative levels, making the impact of energy actions visible to users. Energy use is divided into district heating and hot water, as well as facilities electricity in apartment buildings. Users can switch between the views per month or per year to show overall changes. %Since the energy data is shared between cooperatives there may also be privacy concerns related to opening up data of higher granularity to people outside of the own cooperative. 
%
\begin{figure}[t!]
	%\centering
	\sidecaption[t]
...
\subruninhead{Comparing Housing Cooperatives}
...
% 
Users can also see the energy performance as a number (in kWh/m$^2$), and the information about energy reduction actions of the cooperatives. %The number of actions is important to display to make energy reduction efforts of housing cooperatives with high energy performance (e.g. due to poor construction of the building) visible. 
% 
...
\subruninhead{Sharing Experiences}
...
\subruninhead{Historical and Quasi Real-time Consumption and Production}
...
\end{figure}
%
When smart plugs are installed, users can view the daily consumption (in Wh) of the corresponding connected appliances of their own household for a chosen period. % (Figure~\ref{fig:viz_hist} a). 
This helps them gain better insights into the individual appliance's consumption level and its daily or seasonal patterns. 
...
\subruninhead{Dynamic ToU Signals}
...
This module aims to %provide actionable suggestions to 
...
\subruninhead{Free Choice and Self-monitoring of Energy Conservation Actions}

Actions are not meant to prescribe what users should do but to present different ideas of what they can do (and how) in household practices. 
...
\subruninhead{Promoting Motivation and Engagement}
