...
taly and Sweden hosted two pilots each. In the former, the work focused on cooperative owned 
...
Therefore, the overarching purpose, the underlying infrastructure and the core features of 
\textbf{CIVIS Platform} \textit{[how do we refer to it? as platform or as STS?]} had to integrate 
