...
This section presents the EU CIVIS project\footnote{\url{http://cordis.europa.eu/project/rcn/110429\_en.html}} as an illustration of designing STS.  The project took place under EU's interest to address the societal challenges of energy transition. The vision of smart grids and the use of IoT and ICT are 
...
In the following, we first review the literature about IoT with regard to smart grids and STS,
...
% 
where IoT devices are expected to cooperate, actively share their energy, and participate in energy management \cite{karnouskos2010cooperative}. 
...
Under these conditions, many new challenges and possibilities emerge, particularity from a socio-technical perspective  \cite{Shin2014}. 

\subsection{An Overview of Design Situation}

 CIVIS was a three-year project that pursued the design, prototyping and real-world piloting of 
